...
function intro(){
    let introduccion = decir("este es el apartado de Informacion, los textos disponibles son los siguientes, que es la ceguera, causas de la ceguera, tipos de ceguera, leyes sobre la ceguera, normativas"); 
}
